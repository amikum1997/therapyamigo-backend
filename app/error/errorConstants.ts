export const GeneralError = Object.freeze({
    SOMETHING_WENT_WRONG : "Sorry!! Something Went Wrong, Please Retry",
    EMAIL_ALEADY_EXIST : "TherapyAmigo account already exist with this email. If you have forgot passowrd please try resetting password.",
    PHONE_ALEADY_EXIST : "TherapyAmigo account already exist with this phone number.Please Try to signup with different phone number ",
    NO_ACCOUNT_EXIST : "TherapyAmigo account does not exist with this email. Retry with the correct ID or Sign Up.",
